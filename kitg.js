...
function Timepage() {
        ...
        if (gamePage.workshop.get("chronoforge").researched){
            ...
            var fast_combust = Math.max(gamePage.resPool.get("timeCrystal").value, 600) < gamePage.resPool.get("void").value  &&  gamePage.time.heat < gamePage.getEffect("heatMax") && gamePage.time.meta[0].meta[4].val >= 1
