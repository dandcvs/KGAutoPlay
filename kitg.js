...
function getFaithProdCap(){
    ...
    return gamePage.getHyperbolicEffect(rate, Math.min(500+((gamePage.religion.getTranscendenceLevel()+1)/Math.max(10,gamePage.religion.getTranscendenceLevel()+1)*500),950)) * (1 + atheismBonus + blackObeliskBonus);
}
