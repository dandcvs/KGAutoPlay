...
function autoCraft2() {
        ...
        if (gamePage.science.get("construction").researched && gamePage.tabs[3].visible ) {
            ...
            let  resourcesAll = [
                ...
                ["plate", [["iron",125]],gamePage.ironWill ? 15 :gamePage.resPool.get("plate").value < 150 ? 150 : (gamePage.bld.getBuildingExt('reactor').meta.unlocked && !gamePage.tabs[0].buttons[25].model.resourceIsLimited) ? gamePage.tabs[0].buttons[25].model.prices[1].val : Math.min(gamePage.resPool.get("iron").value/125*gamePage.getCraftRatio()+1,50000),true, true],
