                ...
                try {
                    for (var t = 1 ;t < chronoforge.length; t++) {
                        if (!switches['CollectResBReset'] ) {
                            ...
                            {}
                            else if ( (t == 7) && (typeof voidcf !== 'undefined') && (chronoforge[t].model.prices.filter(res => res.name == 'void')[0].val > voidcf * 0.1) )
                            {}
