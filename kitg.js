...
function autoCraft2() {
            ...
            var  resourcesAll = [
                ...
                ["alloy", [["steel",75],["titanium",10]], gamePage.resPool.get("eludium").value > 125 ? gamePage.resPool.get("steel").value : gamePage.resPool.get("titanium").value < 20 ? 0 : Math.min(Math.max(gamePage.resPool.get("steel").value/75*(gamePage.getCraftRatio()+1),gamePage.resPool.get("titanium").value/10*(gamePage.getCraftRatio()+1)),1000),false, true],
