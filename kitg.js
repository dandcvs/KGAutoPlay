...
function autoCraft2() {
        ...
        if (gamePage.science.get("construction").researched && gamePage.tabs[3].visible ) {
            ...
            let  resourcesAll = [
                ...
                ["steel", [["iron",100],["coal",100]],Math.min(Math.max(gamePage.resPool.get("iron").value/100*gamePage.getCraftRatio()+1,gamePage.resPool.get("coal").value/100*gamePage.getCraftRatio()+1,75),50000),true, true],
