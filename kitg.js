...
function getFaithProdCap(){
    ...
    return gamePage.getHyperbolicEffect(rate, Math.min(((gamePage.religion.getTranscendenceLevel()+1) / 100 ) * gamePage.religion.getProductionBonus()*10,950)) * (1 + atheismBonus + blackObeliskBonus + (gamePage.getHyperbolicEffect(rate, Math.min(((gamePage.religion.getTranscendenceLevel()+1) / 100 ) * gamePage.religion.getProductionBonus()*10,950)) < 100 ? gamePage.religion.getTranscendenceLevel() : 0));
}
...
function autoPraise(){
	if (gamePage.religionTab.visible) {
	    ...
	    if (gamePage.religion.meta[1].meta[5].val == 1) {
            ...
            if (gamePage.getEffect("voidResonance") > 0 && gamePage.religion.getRU("apocripha").on && (gamePage.religion.faith / gamePage.religion.getProductionBonus()) >  gamePage.resPool.get("faith").maxValue * 10){
            ...
            else if ( gamePage.religion.getRU("apocripha").on && (gamePage.religion.faith / gamePage.religion.getProductionBonus()) >  gamePage.resPool.get("faith").maxValue * 10){
                gamePage.religionTab.resetFaithInternal(1.01);
            }
