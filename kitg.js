        ...
        if (gamePage.workshop.get("chronoforge").researched){
            ...
            if (!switches['CollectResBReset'] || gamePage.time.meta[0].meta[4].val >= 1) {
                if ( gamePage.resPool.energyProd - gamePage.resPool.energyCons >= 0 && gamePage.calendar.day > 0 && (gamePage.resPool.get("antimatter").value < gamePage.resPool.get("antimatter").maxValue || (gamePage.calendar.cycle != 5 || (gamePage.time.meta[0].meta[4].val >= 1 && gamePage.resPool.get("timeCrystal").value >= 1 ))) && ((gamePage.calendar.cycle != 5 || (gamePage.workshop.get("relicStation").unlocked && !gamePage.workshop.get("relicStation").researched && (gamePage.resPool.get("timeCrystal").value > (fast_combust ? 5 : 45) && gamePage.bld.getBuildingExt('chronosphere').meta.val >= 10) && gamePage.space.getBuilding('sunlifter').val > 0 ))  || ( gamePage.time.meta[0].meta[4].val >= 1 && ((gamePage.time.heat == 0 && (gamePage.calendar.cycle != 5 || gamePage.calendar.season > 0 ))  || ( (fast_combust ? true : gamePage.time.heat + 50 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 5 && gamePage.calendar.cycle == 5 &&  (gamePage.calendar.season > 0 || ((fast_combust ? true : gamePage.time.heat < gamePage.getEffect("heatMax") * 0.5)  && gamePage.calendar.day < 10) ) ) ) )  )) {
                    if ((!(gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value > gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)) && (chronoforge[0].model.fiveErasLink && chronoforge[0].model.fiveErasLink.visible)  && (fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor * 250) && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val * 250)  || ( gamePage.time.meta[0].meta[4].val >= 3  && ( (gamePage.time.heat == 0 && gamePage.resPool.get("timeCrystal").value > 250 ) || ( (fast_combust ? true : gamePage.time.heat + 250 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 250 && gamePage.calendar.cycle == 5) ) ) ){
                    ...
                    else if ((!(gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value > gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)) && (chronoforge[0].model.sameCycleRestartLink && chronoforge[0].model.sameCycleRestartLink.visible)  && (fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor * 45)  && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val * 45)  || ( (gamePage.time.meta[0].meta[4].val >= 3 || (!gamePage.ironWill && gamePage.time.meta[0].meta[4].val >= 1)) && ( (gamePage.time.heat == 0 && gamePage.resPool.get("timeCrystal").value > 45 ) || ((fast_combust ? true : gamePage.time.heat + 50 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 45 && gamePage.calendar.cycle == 5) ) ) ){
