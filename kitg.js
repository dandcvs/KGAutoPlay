...
function autoAssign() {
        var resourcesAssign = {
            ...
            "science": ["science", "scholar",(gamePage.resPool.get("science").value < gamePage.resPool.get("science").maxValue * 0.5) ? 0.5 : 1, gamePage.science.get('engineering').researched  ? 1 : (gamePage.village.getKittens() > 1 ? 0.1 : 0.001)],
