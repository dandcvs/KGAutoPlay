...
function autoPraise(){
	...
	if (gamePage.religionTab.visible && !gamePage.challenges.isActive("atheism")) {
	    ...
	    if (gamePage.religion.meta[1].meta[5].val == 1) {
            ...
            if (gamePage.religion.getSolarRevolutionRatio() > gamePage.religion.transcendenceTier * 0.05 && gamePage.getEffect("voidResonance") > 0 && gamePage.religion.getRU("apocripha").on  && gamePage.religion.getRU("transcendence").on && (gamePage.religion.faith / gamePage.religion.getApocryphaBonus()) >  gamePage.resPool.get("faith").maxValue * Math.min(gamePage.religion.transcendenceTier, 10, Math.max(gamePage.religion.transcendenceTier * 0.05, gamePage.getEffect("solarRevolutionLimit")))){
                gamePage.religion.resetFaith(1.01, false);
            }
            else if (gamePage.religion.getSolarRevolutionRatio() > gamePage.religion.transcendenceTier * 0.05 && gamePage.religion.getRU("apocripha").on && gamePage.religion.getRU("transcendence").on && (gamePage.religion.faith / gamePage.religion.getApocryphaBonus()) >  gamePage.resPool.get("faith").maxValue * Math.min(gamePage.religion.transcendenceTier, 10, Math.max(gamePage.religion.transcendenceTier * 0.05, gamePage.getEffect("solarRevolutionLimit")))){
                gamePage.religion.resetFaith(1.01, false);
            }
