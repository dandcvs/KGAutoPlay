                 ...
                 if (btn[i].model.metadata.val/5 < spcEntangler.val){
                   ...
                   if (!btn[i].model.metadata.effects.maxKittens)
                  {
                        if ((!gamePage.workshop.get("goldOre").researched && btn[i].model.prices.filter(res => res.name == 'science').length > 0) ||
                            ...
                            (((!gamePage.science.get('philosophy').researched && gamePage.science.get('philosophy').unlocked)||(!gamePage.science.get('theology').researched && gamePage.science.get('theology').unlocked)) && btn[i].model.prices.filter(res => res.name == 'science').length > 0 && && btn[i].model.prices.filter(res => res.name == 'science')[0].val > 1000)
                        )
                        {}
                        else{
                            try {
