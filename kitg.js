...
function autozig() {
    if (gamePage.religionTab.visible) {
        ...
        if (gamePage.resPool.get('timeCrystal').value > 50 && gamePage.resPool.get('timeCrystal').value / Math.max(gamePage.resPool.get("relic").value,1) > 1.3 && gamePage.resPool.get("relic").value > 50) {
