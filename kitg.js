...
function autoCraft2() {
        ...
        if (gamePage.science.get("construction").researched && gamePage.tabs[3].visible ) {
            let  resourcesAll = [
                ...
                ["manuscript", [["parchment",25],["culture",400]],gamePage.ironWill ? 0 : 100],
                ["compedium", [["manuscript",50],["science",10000]],gamePage.ironWill ? f(gamePage.resPool.get('science').value)*2 : 100],
...
function autoAssign() {
        var resourcesAssign = [
        	...
        	["manpower", "hunter",(gamePage.science.get('theology').researched && gamePage.resPool.get("compedium").value < 100 && gamePage.resPool.get("manuscript").value < 100) ? 0.1 : 1 ,5],
