...
function autoCraft2() {
        ...
        if (gamePage.science.get("construction").researched && gamePage.tabs[3].visible ) {
            let  resourcesAll = [
                ...
                ["gear", [["steel",15]],25],
                ["alloy", [["steel",75],["titanium",10]],Math.min(Math.max(Math.min(gamePage.resPool.get("steel").value/75*gamePage.getCraftRatio()+1,gamePage.resPool.get("titanium").value/10*gamePage.getCraftRatio()+1),100),1000)],
