...
function autoCraft2() {
            ...
            if (!gamePage.ironWill && (cntcrafts == 0 || cntcrafts > 200 || (Object.keys(craftPriority[0]).length > 0 && craftPriority[2] != gamePage.bld.getBuildingExt(craftPriority[0]).meta.val))) {
                var Priority_blds = {
                    ...
                    "amphitheatre" : (gamePage.bld.getBuildingExt('amphitheatre').meta.val == 0 && gamePage.resPool.get('parchment').value > 0) ? 7 : gamePage.resPool.get('parchment').value > 0 ? (gamePage.bld.getBuildingExt('amphitheatre').meta.stage == 0 ? 3 : 1) : 0.00000001,
