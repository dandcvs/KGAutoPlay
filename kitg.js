...
function autoTrade() {
        ...
        if ((gamePage.resPool.get('titanium').value < gamePage.resPool.get('paragon').value < 1000 ? gamePage.resPool.get('paragon').value : 200000 || gamePage.resPool.get('blueprint').value < 100) && gamePage.diplomacy.get('zebras').unlocked && gamePage.resPool.get('gold').value > 515 && gamePage.resPool.get('gold').value < gamePage.resPool.get('gold').maxValue * 0.95) {
