...
function autoCraft2() {
            ...
            var  resourcesAll = [
                ...
                ["eludium", [["unobtainium",1000],["alloy",2500]], gamePage.resPool.get("eludium").value < 125 ? 125 : (gamePage.bld.getBuildingExt('chronosphere').meta.val < 10 ? 125 : (gamePage.resPool.get("unobtainium").value > gamePage.resPool.get("unobtainium").maxValue * 0.9 || gamePage.resPool.get("unobtainium").value >= gamePage.resPool.get("eludium").value) ? gamePage.resPool.get("timeCrystal").value * 5 + 1 : 0), false, true],
