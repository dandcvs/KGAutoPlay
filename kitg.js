...
function autoAssign() {
        var resourcesAssign = [
       		["catnip", "farmer",gamePage.resPool.get("catnip").value < gamePage.resPool.get("catnip").maxValue * 0.05 ? 0.1 : gamePage.resPool.get("beam").value > gamePage.resPool.get("catnip").maxValue ? (gamePage.resPool.get("beam").value / gamePage.resPool.get("catnip").maxValue + 9) :9, (gamePage.resPool.get('paragon').value < 100 && gamePage.bld.getBuildingExt('temple').meta.val < 1) ? 0.1 : 1],
