                 ...
                 if (!switches['CollectResBReset'] || btn[i].model.prices.filter(res => res.name == 'relic' || res.name == 'timeCrystal' || res.name == 'void').length == 0) {
                     if ((goldebBuildings.includes(btn[i].model.metadata.name) && !gamePage.ironWill) || (gamePage.ironWill && gamePage.bld.buildingsData[27].val > 3 && goldebBuildings.includes(btn[i].model.metadata.name))){
                        ...
                        if ( ( (gamePage.religion.getZU("marker").val > 10 || gamePage.workshop.get("chronoforge").researched) && gamePage.bld.getBuildingExt('chronosphere').meta.val >= 10 && (gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value < gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)) ) || (gamePage.bld.getBuildingExt('chronosphere').meta.val < 20 && gamePage.timeTab.visible  &&  gamePage.resPool.get("timeCrystal").value - Chronosphere10SummPrices()[1].val > 100 && gamePage.time.meta[0].meta[4].val > 0) || (gamePage.bld.getBuildingExt('chronosphere').meta.val < 10 && (gamePage.resPool.get("unobtainium").value >= Chronosphere10SummPrices()[0].val  && gamePage.resPool.get("timeCrystal").value >= Chronosphere10SummPrices()[1].val )) ){
                          ...
                          {
                                if ((btn[i].model.metadata.name == "pasture" && !gamePage.religion.getRU('solarRevolution').val) || (!gamePage.workshop.get("goldOre").researched && btn[i].model.prices.filter(res => res.name == 'science').length > 0) ||
    ...
    if (gamePage.religionTab.visible) {
        ...
        if (gamePage.religionTab.sacrificeBtn && gamePage.resPool.get('unicorns').value > gamePage.resPool.get('tears').value ){
            ...
            if (btn.length > 0 &&  ((btn[0].model.prices[0].val - gamePage.resPool.get('unicorns').value) / (gamePage.getResourcePerTick('unicorns', true) * gamePage.getRateUI()))/60 > 5){
                if(gamePage.religionTab.sacrificeBtn.model.allLink.visible){
                    gamePage.religionTab.sacrificeBtn.controller.sacrificeAll(gamePage.religionTab.sacrificeBtn.model,gamePage.religionTab.sacrificeBtn.controller._canAfford(gamePage.religionTab.sacrificeBtn.model),function(result){
                     if (result) {
        ...
        if (gamePage.resPool.get('alicorn').value > 25 && (switches['CollectResBReset'] || gamePage.resPool.get('alicorn').value > gamePage.resPool.get("timeCrystal").value || (gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value > gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)))) {
            if (gamePage.religionTab.sacrificeAlicornsBtn.model.allLink.visible){
                gamePage.religionTab.sacrificeAlicornsBtn.controller.sacrificeAll(gamePage.religionTab.sacrificeAlicornsBtn.model,gamePage.religionTab.sacrificeAlicornsBtn.controller._canAfford(gamePage.religionTab.sacrificeAlicornsBtn.model),function(result){
                 if (result) {
...
function Timepage() {
        ...
        if (gamePage.workshop.get("chronoforge").researched){
            ...
            var fast_combust = Math.max(gamePage.resPool.get("timeCrystal").value, 600) < gamePage.resPool.get("void").value  &&  (gamePage.calendar.darkFutureYears(true) < 0 ? chronoforge[0].controller.getPrices(chronoforge[0].model)[0].val <= 1 : gamePage.time.heat < gamePage.getEffect("heatMax") ) && gamePage.time.meta[0].meta[4].val >= 1
            if (!switches['CollectResBReset'] || gamePage.time.meta[0].meta[4].val >= 1) {
                if ( gamePage.resPool.energyProd - gamePage.resPool.energyCons >= 0 && gamePage.calendar.day > 0 && (gamePage.resPool.get("antimatter").value < gamePage.resPool.get("antimatter").maxValue || (gamePage.calendar.cycle != 5 || (gamePage.time.meta[0].meta[4].val >= 1 && gamePage.resPool.get("timeCrystal").value >= 1 ))) && ((gamePage.calendar.cycle != 5 || (gamePage.workshop.get("relicStation").unlocked && !gamePage.workshop.get("relicStation").researched && (gamePage.resPool.get("timeCrystal").value > (fast_combust ? 5 : 45) && gamePage.bld.getBuildingExt('chronosphere').meta.val >= 10) && gamePage.space.getBuilding('sunlifter').val > 0 ))  || ( gamePage.time.meta[0].meta[4].val >= 1 && ((gamePage.time.heat == 0 && (gamePage.calendar.cycle != 5 || gamePage.calendar.season > 0 ))  || ( (fast_combust ? true : gamePage.time.heat + 50 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 5 && gamePage.calendar.cycle == 5 &&  (gamePage.calendar.season > 0 || (fast_combust ? true : gamePage.time.heat < gamePage.getEffect("heatMax") * 0.5 && gamePage.calendar.day < 10)  ) ) ) )  )) {
                    if ((chronoforge[0].model.fiveErasLink && chronoforge[0].model.fiveErasLink.visible) && ((!(gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value > gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)) && (fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor * 250) && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val * 250)  || ( gamePage.time.meta[0].meta[4].val >= 3  && ( (gamePage.time.heat == 0 && gamePage.resPool.get("timeCrystal").value > 250 ) || ( (fast_combust ? true : gamePage.time.heat + 250 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 250 && gamePage.calendar.cycle == 5) ) ) ) ){
                        chronoforge[0].controller.doShatterAmt(chronoforge[0].model, 5 * gamePage.calendar.yearsPerCycle * gamePage.calendar.cyclesPerEra)
                        chronoforge[0].update();

                    }
                    else if ((chronoforge[0].model.sameCycleRestartLink && chronoforge[0].model.sameCycleRestartLink.visible) && ( (!(gamePage.time.meta[0].meta[4].unlocked && gamePage.resPool.get("timeCrystal").value > gamePage.timeTab.cfPanel.children[0].children[5].model.prices[0].val * (gamePage.timeTab.cfPanel.children[0].children[5].model.metadata.val > 2 ? 0.1 : 0.05)) && (fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor * 45)  && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val * 45)  || ( (gamePage.time.meta[0].meta[4].val >= 3 || (!gamePage.ironWill && gamePage.time.meta[0].meta[4].val >= 1)) && ( (gamePage.time.heat == 0 && gamePage.resPool.get("timeCrystal").value > 45 ) || ((fast_combust ? true : gamePage.time.heat + 50 * factor < gamePage.getEffect("heatMax")) && gamePage.resPool.get("timeCrystal").value > 45 && gamePage.calendar.cycle == 5) ) ) )){
                    ...
                    else if (gamePage.calendar.cycle != 4 && (chronoforge[0].model.nextCycleLink && chronoforge[0].model.nextCycleLink.visible) &&  (fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor * 5) && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val*5){
                        chronoforge[0].controller.doShatterAmt(chronoforge[0].model, gamePage.calendar.yearsPerCycle)
                        chronoforge[0].update();
                    }
                    else if ((fast_combust ? true : gamePage.getEffect("heatMax") - gamePage.time.heat > factor)  && gamePage.resPool.get("timeCrystal").value > chronoforge[0].model.prices[0].val) {
                            try {
